...
Webflow.require('ix').init([
  {"slug":"loader","name":"Loader","value":{"style":{"display":"block","opacity":1},"triggers":[{"type":"load","preload":true,"stepsA":[{"opacity":0,"transition":"opacity 1000ms ease-out 0ms"},{"display":"none"}],"stepsB":[]}]}}
]);
